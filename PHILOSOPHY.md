# interpeer Philosophy

## Purpose
Cross-AI peer review — quick (Claude↔Codex), deep (Oracle), council (multi-model), mine (disagreement extraction).

## North Star
Advance interpeer through small, testable changes aligned to its core mission: Cross-AI peer review — quick (Claude↔Codex), deep (Oracle), council (multi-model), mine (disagreement extraction).
